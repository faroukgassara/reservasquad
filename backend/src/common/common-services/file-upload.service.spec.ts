...
describe('fileUploadService', () => {
  ...
  it('should convertBase64', async () => {
    ...
    await service.convertBase64(
      'test',
      'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAYkAAAEVCAYAAAAVeRmFAAABP2lDQ1BJQ0MgUHJvZmlsZQAAKJFjYGASSCwoyGFhYGDIzSspCnJ3UoiIjFJgf8rAyiDMwMkgwmCUmFxc4BgQ4ANUwgCjUcG3awyM',
    );
    expect(spy).toBeCalled();
  });
