...
import IUploadDropzone from '@/interfaces/IPrimitives/IUploadDropzone/IUploadDropzone';
...
export default function UploadDropzone({
  ...
  return (
    ...
    >
      ...
      <Label variant={EVariantLabel.bodySmall} color="text-primary-500" className="cursor-pointer hover:underline text-center">
        Parcourir
      </Label>
      {description && (
